...
//    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
            .authorizeRequests()
            .antMatchers("/resources/view/public/**").permitAll()
            ...
            .and()
            .formLogin()
            .defaultSuccessUrl("/resources/view/restricted/userHome-view.html")
           ...
           // .successHandler(new AjaxAuthenticationSuccessHandler(new SavedRequestAwareAuthenticationSuccessHandler()))
            ...
            .logout()
            .logoutUrl("/logout")
            .logoutSuccessUrl("/resources/view/public/home-view.html")
            .permitAll();
